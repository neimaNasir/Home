...
<section class="faq" id="faq">
   ...
   <div class="box-container">
      ...
      <div class="box active">
         ...
         <p>Cancel booking after letting the house owner know.</p>
      </div>

      <div class="box active">
         <h3><span>when will I get the possession?</span><i class="fas fa-angle-down"></i></h3>
         <p>As soon as the legal documents are done thats with in 2-3 months.</p>
      </div>

      <div class="box">
         <h3><span>where can I pay the rent?</span><i class="fas fa-angle-down"></i></h3>
         <p>You can pay using telebirr, chappa ,cbebirr or amole.</p>
      </div>

      <div class="box">
         <h3><span>how to contact with the buyers?</span><i class="fas fa-angle-down"></i></h3>
         <p>After accepting their enquiry request, you can have the buyers phone no.</p>
      </div>

      <div class="box">
         <h3><span>why my listing not showing up?</span><i class="fas fa-angle-down"></i></h3>
         <p>Maybe because you don't have a listing if not contact us to fix the problem.</p>
      </div>
